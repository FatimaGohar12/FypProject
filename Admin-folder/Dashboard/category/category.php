      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Categories</h1>
              <a href="./categoryinsert.php" class="btn btn-primary my-3">Create New</a>
            </div>
          </div>
        </div>
      </section>
                ...
                <div class="card-body">
                  <table class="table table-striped table-hover" id="myTable" style="text-align:center;">
                    ...
                    <tr>
                      <th scope='row'>" . $sno . "</th>
                      <td>" . $catname . "</td>
                      <td>" . substr($catdesc, 0, 40) . "</td>
                      <td>
                        <img src='" . $image . "' alt='Category Image' width='100px'>
                      </td>
                      <td>
                        <form action='./categoryupdate.php' method ='GET'>
<input type='hidden' name='catid' value=" . $catid . " >
                          <input type='submit' id='update' name ='update' value='Update' class='btn btn-success'>
                        </form>
                      </td>
                      <td>
                        <input type='button' id='' name='' value='Delete' data-id='" . $catid  . "' class='btn-delete-cat btn btn-danger'>
                      </td>
                    </tr>";
                      }
                      ?>
