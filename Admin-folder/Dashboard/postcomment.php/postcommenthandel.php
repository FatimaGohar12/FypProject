...
<input type='button' id='' name ='' value='Delete' data-id='" .  $comment_id . "' class='btn-delete-post btn btn-danger'>
    ...
    $("body").on("click", ".btn-delete-post", function() {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You are about to delete this Post comment.',
            icon: 'warning',
                    ...
                    success: function(response) {
                        ...
                        if (response.code == 200) {
                            ...
                            Swal.fire({
                                ...
                                text: 'The Post Comment has been successfully deleted.',
                                icon: 'success'
                            }).then(res => {
