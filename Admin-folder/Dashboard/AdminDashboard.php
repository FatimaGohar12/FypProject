    ...
    <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="../Adminsite//Images/userdeafult.jpg" class="img-circle elevation-2 my-2" alt="User Image">
          ...
          <div class="row justify-content-center">
            <div class="col-md-4">
              <div class="card bg-primary text-white">
                <div class="card-body">
                  <h1 class="card-title" style="font-size : 1.7rem"><i class="fas fa-users"></i> Total Users</h1>
                  <p class="card-text">
                    <?php
                    ...
                    echo '<p style="font-size: 1.7rem;">' . $totalUsers . '</p>';
            ...
            <div class="col-md-4">
              <div class="card bg-danger text-white">
                <div class="card-body">
                  <h1 class="card-title " style="font-size : 1.7rem"><i class="fas fa-file-alt"></i> Total Posts</h1>
                  <p class="card-text">
                    <?php
                    ...
                    echo '<p style="font-size: 1.7rem;">' . $totalPosts . '</p>';
                    ?>
                  </p>
                </div>
              </div>
            ...
            <div class="col-md-4">
              <div class="card bg-success text-white">
                <div class="card-body">
                  <h1 class="card-title" style="font-size : 1.7rem"><i class="fas fa-folder"></i> Total Categories</h1>
                  <p class="card-text">
                    <?php
                    // Fetch the total number of categories from the database
                    ...
                    echo '<p style="font-size: 1.7rem;">' . $totalCategories . '</p>';
                    ?>
                  </p>
                </div>
              </div>
