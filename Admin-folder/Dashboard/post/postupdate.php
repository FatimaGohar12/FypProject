...
$sql = "SELECT posts.*,users.* FROM posts LEFT JOIN users ON users.sno=posts.post_user_id WHERE posts.post_id = $post_id";
            ...
            <section class="content">
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control rounded-0 mx-2" name="title" id="title" value="<?php echo "$updatetitle" ?>">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="title" class="control-label mx-2 ">Content</label>
                        <textarea class="form-control" id="" rows="4" style="height: 209px;" name="content"><?php echo "$updatecontent" ?></textarea>
                    </div>
