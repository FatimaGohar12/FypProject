...
if (isset($_GET['threadid'])) {
    ...
    $sql = "SELECT thread.*, categories.`cat-name` AS category_name
            FROM thread
            RIGHT JOIN `categories` ON categories.`cat-id` = thread.thread_cat_id
            ...
            <section class="content">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <label for="category" class="control-label mx-2">Category</label>
                        <input type="text" class="form-control rounded-0 mx-2" name="category" id="category" value="<?php echo $category; ?>" disabled>
                    </div>
                    <div class="form-group">
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE thread
    SET `thread_title` = '$title', `thread_desc` = '$content'
