            ...
            <section class="content">
                <form action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
                    <div class="form-group">
                        <label for="title" class="control-label mx-2 ">Name</label>
                        <input type="text" class="form-control rounded-0 mx-2" name="postname" id="name" value="<?php echo "$updatename" ?>">
                    </div>
                    <div class="form-group">
                        <label for="title" class="control-label mx-2 ">Age</label>
                        <input type="text" class="form-control rounded-0 mx-2" name="age" id="age" value="<?php echo "$updateage" ?>">
                    </div>

                    <div class="form-group">
                        <label for="title" class="control-label mx-2 ">Location</label>
                        <input type="text" class="form-control rounded-0 mx-2" name="location" id="location" value="<?php echo "$updatelocation" ?>">
                    </div>

                    <div class="form-group">
                        <label for="title" class="control-label mx-2 ">Email</label>
                        <input type="text" class="form-control rounded-0 mx-2" name="email" id="email" value="<?php echo "$updateemail" ?>">
                    </div>

                    <div class="form-group">
                        <label for="title" class="control-label mx-2 ">Education</label>
                        <input type="text" class="form-control rounded-0 mx-2" name="education" id="education" value="<?php echo "$updateeducation" ?>">
                        <input type="hidden" class="form-control rounded-0 mx-2" name="userid" id="userid" value="<?= $user_id ?>">

                    </div>


                    <button class="btn btn-success btn-lg" type="submit" name="UpdateSubmit">UPDATE</button>
        </div>
        </form>
        <!-- /.card -->
    </div>
...
if (isset($_POST['UpdateSubmit'])) {
    ...
    $sql = "UPDATE users SET email= '$email', name='$name', age = $age,Location='$location' WHERE sno='$user_id'";
    ...
    if ($result) {
        echo "
         ...
         Swal.fire({
            ...
            window.location.href = './userhandel.php';
        })
        </script>
        ";
    } else {
