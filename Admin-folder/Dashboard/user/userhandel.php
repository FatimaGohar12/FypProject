            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Users Reccord</h1>
                            <!-- <a href="./userinsert.php" class="btn btn-primary my-3">Create New</a> -->
...
<input type='button' id='' name ='' value='Delete' data-id='" . $user_id . "' class='btn-delete-post btn btn-danger'>
