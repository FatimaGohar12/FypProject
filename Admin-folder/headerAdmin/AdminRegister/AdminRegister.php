	...
	<div class="login-box">
		...
		<div class="card card-navy my-2">
			<div class="card-body">
				...
				<form id="login-frm" action="http://localhost/Forum2/Admin-folder/headerAdmin/AdminRegister/Registerhandel.php" method="post">
					<div class="input-group mb-3">
						<input type="text" class="form-control" name="user" id="user" autofocus="" placeholder="Username">
					...
					<div class="input-group mb-3">
						<input type="password" class="form-control" name="registercpass" id="registercpass" placeholder="Confirm Password">
						<div class="input-group-append">
							<div class="input-group-text">
								<span class="fas fa-lock"></span>
							</div>
					...
					<div class="row">
						<div class="col-8">
							<a href="http://localhost/Forum2/Admin-folder/headerAdmin/Adminlogin/adminlogin.php">Login</a>
						</div>
						<!-- /.col -->
						<div class="col-4">
